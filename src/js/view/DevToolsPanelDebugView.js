        ...
        return (
            <div id = "dev-tools-panel-debug-view">
                <div className="content top">
                    <div className="left">Encoded</div>
                    <div className = "right">Decoded</div>
                </div>
                <div className = "content bottom">
                    <div className = "left" >
                    <JwtTextArea colorize = { true }
                        placeholder = "Paste your JWT here"
                        onChange = { this.onJwtInputChange.bind(this) }
                        jwt = { jwtValue }
                    /> </div> <div className = "right" > {
                        jwtValue === '' ?
                        <div className = "no-jwt message"> <i className="fa fa-long-arrow-left"
                        aria-hidden = "true"> </i> Nothing to show</div > :
                            (parsedJwt ?
                                <
                                JwtDetail jwt = { parsedJwt }
                                /> : <p className = "error message" > The JWT that you 've entered isn'
                                t valid. </p>
                            )
                    }
                    </div>
